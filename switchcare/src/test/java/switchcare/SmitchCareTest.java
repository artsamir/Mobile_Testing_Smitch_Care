...
import HealthcareApp.SmitchCareCapabilities;
...
public class SmitchCareTest extends SmitchCareCapabilities{
...
//		driver.findElement(MobileBy.id("com.mysmitch.care:id/txtLogin")).click();
	...
	public void verifyNutration() throws InterruptedException {
		
		Thread.sleep(10000);
		// Click nuration
		driver.findElement(MobileBy.id("com.mysmitch.care:id/nutrition_image")).click();
		// Click view Nutrition history
		
		driver.findElement(MobileBy.id("com.mysmitch.care:id/btnViewHistory")).click();
		Thread.sleep(2000);
		// perform scrolling
		int startX = 365;
		int startY = 1270;
		...
		int endY2 = 286;
		TouchAction scrollAction2 = new TouchAction(driver);
		scrollAction2.press(PointOption.point(startX, startY)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).moveTo(PointOption.point(endX, endY))
		.release().perform();
		...
		int startY3 = 1255;
		int endY3 = 235;
		TouchAction scrollAction3 = new TouchAction(driver);
		scrollAction2.press(PointOption.point(startX, startY)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).moveTo(PointOption.point(endX, endY))
		.release().perform();
	}
